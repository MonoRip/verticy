;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="b53308b9e884af25d36e50a6c7559009";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["aOMBJyK0LfWP"]={appId:"Ek_0U0d0YWhZ",scope:{}};;CloudflareApps.installs["aOMBJyK0LfWP"].options={};;CloudflareApps.installs["fFsSzjYBO9tW"]={appId:"t8Sk01am_9iA",scope:{}};;CloudflareApps.installs["fFsSzjYBO9tW"].options={"advancedOptions":{"disableOnAJAX":false,"disableOnPushState":false},"color":"purple","hidePage":false,"showAdvanced":false,"theme":"minimal"};;CloudflareApps.installs["fFsSzjYBO9tW"].URLPatterns=["^blog.aeong.one/?.*$","^twitchmod.aeong.one/?.*$"];;if(CloudflareApps.matchPage(CloudflareApps.installs['aOMBJyK0LfWP'].URLPatterns)){(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId])
...
if(!document.querySelector('.pace')){return setTimeout(Pace.start,50);}else{Pace.trigger('start');return Pace.go();}};if(typeof define==='function'&&define.amd){define(function(){return Pace;});}else if(typeof exports==='object'){module.exports=Pace;}else{if(options.startOnPageLoad){Pace.start();}}}).call(this);};(function(){try{var link=document.createElement('link');link.rel='stylesheet';link.href='data:text/css;charset=utf-8;base64,';document.getElementsByTagName('head')[0].appendChild(link);}catch(e){}})();